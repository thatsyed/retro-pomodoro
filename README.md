...
- **Zero-Bandwidth Web Audio Ambient Synthesizer**: Procedural focus sound generator for *Rain*, *Vinyl Crackle*, *Pink Noise*, and *Cafe Murmur*.
- **Lo-Fi Tape Deck**: Seamless looping audio tracks (*Morning Coffee*, *Lo-Fi Chill*, *Starlit Focus*) paired with an animated 10-bar reactive pixel equalizer.
